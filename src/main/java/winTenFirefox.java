...
public class winTenFirefox {
    ...
    public void win10firefox(RemoteWebDriver driver)
    {
        try{
            ...
            ScreenshottestingAuto.screenShotNavigation firefoxten = new ScreenshottestingAuto.screenShotNavigation();
            firefoxten.navigation(driver);
            ScreenshottestingAuto.DriverMethods dffertime = new ScreenshottestingAuto.DriverMethods();
            ...
            ScreenshottestingAuto.MarkAsBug firefoxtenpoint = new ScreenshottestingAuto.MarkAsBug();
